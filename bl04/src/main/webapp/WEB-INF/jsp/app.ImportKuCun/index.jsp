...
<nav class="breadcrumb">
	...
	<span class="c-gray en">&gt;</span> 导入库存 
...
<div class="pt-5 pr-5 pl-20">
	...
	<div>
		<form action="ImportKuCun/upload" method="post" enctype="multipart/form-data">
			<input type="file" name="excelFile" accept=".xls,.xlsx">
			<input type="submit" value="上传">
		</form>
	</div>
			<div>
			<h3><a href="doc/Import-KuCun-tpl.xls" target="_new">《库存数据模板下载》</a></h3>
			</div>
			
			<div>
			导入说明：
			<ul>
				<li>请检查每一行数据的完整性，料号、品名、库存数量必填；</li>
				<li>导入时会把历史库存数据清空；</li>
			</ul>
			</div>
</div>
